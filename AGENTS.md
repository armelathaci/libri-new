# Libri_new — ADT Bundle Reference
...
**Libri_new** — Ky libër për fëmijë trajton ndryshimet klimatike dhe ndikimin e tyre në natyrë, përmes një tregimi me vargje ku Mali dëgjon rrëfimin e gjyshit për lumin e tharë, pyllin e dëmtuar dhe jetën e egër që është zhdukur. Gjuha është shqip dhe, nga përdorimi i formave si “m’e hedhë” dhe “fëmijë”, duket se vjen nga hapësira shqipfolëse e Kosovës ose trojeve përreth; i përshtatet kryesisht moshave të ciklit fillor. Libri ka qasje edukative e ndërgjegjësuese, duke lidhur kujtimet familjare me mësimin për mjedisin dhe duke i nxitur fëmijët të lexojnë, të mësojnë dhe të veprojnë për mbrojtjen e klimës.

- **Source language**: `sq-XK`
- **Available languages in this bundle**: `sq-XK`
- **Total pages**: 22
- **Glossary**: yes
...
│   │   └── i18n/
│   │       └── {lang}/               # One directory per language: sq-XK
...
├── Libri_new.db                    # SQLite database (pipeline state)
├── Libri_new.pdf                   # Original source PDF
...
```json
[
  { "section_id": "pg003_sec001", "href": "index.html" },
  ...
  { "section_id": "pg007_sec001", "href": "pg007_sec001.html" }
]
```
...
```json
{
  ...
  "pg001_im001": "",
  "gl001": "acar",
  "gl001_def": "Ft i madh dhe i ashpër."
}
```
...
```json
{
  "acar": {
    "word": "acar",
    "definition": "Ft i madh dhe i ashpër.",
    "variations": ["acari"],
    "emoji": "🥶❄️"
  }
}
...
<html lang="sq-XK">
<head>
    <meta name="title-id" content="pg018_sec001" />      <!-- section identity -->
...
| Original PDF | `Libri_new.pdf` |
| Pipeline database | `Libri_new.db` (SQLite) |
